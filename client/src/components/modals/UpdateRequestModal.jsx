...
const UpdateRequestModal = ({ isOpen, onClose, request }) => {
  ...
  useEffect(() => {
    if (request) {
      const equipmentTypes = request.equipment_list.map(
      ...
      setForm({
        ...
        faculty_in_charge: request.faculty_in_charge,
        equipment_list: equipmentTypes,
        date_use: request.date_use.slice(0, 10),
